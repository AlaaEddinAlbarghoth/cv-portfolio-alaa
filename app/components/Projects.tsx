        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <motion.article
                key={index}
                className="group relative bg-foreground/5 rounded-2xl p-6 hover:bg-foreground/10 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl border border-gray-200/10 hover:border-blue-500/30"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="relative z-10">
                  ...
                  {project.period && (
                    <div className="text-sm text-blue-400 font-semibold mb-4">{project.period}</div>
                  )}
